...
# [omz] TODO check this file's comment/default-scrips with $HOME/.oh-my-zsh/templates/zshrc.zsh-template
...
source "$HOME/zshrc/utils.sh"
source "$HOME/zshrc/_deprecated.sh"
